  ...
  return (
    <div className="vero-wrap">
      ...
      <section className="hero">
        ...
        <h1>Brand deals.<br /><em>Without the trust issues.</em></h1>
      ...
      <section className="section">
        ...
        <div className="problems">
          <div className="problem-card">
            ...
            <p className="problem-desc">Delayed payments, ghosted brands, and zero protection after content goes live. Creators work for free every day across India.</p>
          </div>
          <div className="problem-card">
            <div className="problem-icon">📉</div>
            <div className="problem-title">Brands waste budget on fake views</div>
            <p className="problem-desc">Inflated follower counts, bot engagement, no performance verification. Brands burn money and lose trust in influencer marketing entirely.</p>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="how">
        ...
        <p className="section-sub">VeroLinkr holds payment in escrow until content is verified — then releases automatically.</p>
        <div className="how-steps">
          {[
            { num: '01', title: 'Brand creates a campaign', desc: 'Define deliverables, budget, and timeline. Payment goes into secure Razorpay escrow — not to the creator yet.' },
            { num: '02', title: 'Creators apply and are matched', desc: 'Verified creators browse campaigns. Brands select based on real engagement data — no fake metrics, no guessing.' },
            { num: '03', title: 'Content is created and submitted', desc: 'Creator delivers content through the platform. Brand reviews and approves within the agreed timeline.' },
            { num: '04', title: 'Payment releases instantly', desc: 'On brand approval, Razorpay releases escrow payment to creator. No waiting. No chasing. No ghosting.' },
          ].map((step) => (
      ...
      <section className="section" id="creators">
        ...
        <p className="section-sub">Stop chasing brands for payment. Start focusing on creating.</p>
      ...
      <section className="section" id="brands">
        ...
        <p className="section-sub">Only pay when content is delivered. Find creators who actually convert.</p>
        <div className="features-grid">
          {[
      ...
      <section className="waitlist-section" id="waitlist">
        <div className="waitlist-inner">
          ...
          <p className="waitlist-sub">Join the platform and get founding member benefits.</p>
          {submitted ? (
          ...
          <div style={{ marginTop: '2rem' }}>
            <button className="btn-primary" onClick={onGetStarted} style={{ width: '100%', padding: '1rem' }}>
